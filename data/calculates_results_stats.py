...
def calculates_results_stats(results_dic):
    ...
    # Initializen the results_stats_dic dictionary
    results_stats_dic = {
        'n_images': 0,
        'n_dogs_img': 0,
        'n_notdogs_img': 0,
    ...
    # iterate through result dictionary and update statutics
