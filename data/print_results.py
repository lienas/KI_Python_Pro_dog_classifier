...
def print_results(results_dic, results_stats_dic, model,
    ...
    if (print_incorrect_dogs):
        # AND there were images incorrectly classified as dogs or vice versa
        # - print out these cases
        if ((results_stats_dic['n_correct_dogs'] + results_stats_dic['n_correct_notdogs'])
            ...
            print("\nNo incorrect dog classifications.")

    # IF print_incorrect_breed == True
    if (print_incorrect_breed):
        # AND there were dogs whose breeds were incorrectly classified
        # - print out these cases
        if (results_stats_dic['n_correct_dogs'] != results_stats_dic['n_correct_breed']):
            ...
            print("\nNo incorrect breed classifications.")
